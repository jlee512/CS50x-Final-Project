...
function load_user_total_distance(north_walks_count, south_walks_count) {
    ...
    $.ajax({
        ...
        success: function (data) {
            distance_sum = data[0].total_distance;
...
function construct_tumbler(data) {
    ...
    load_user_total_distance(north_walks_count, south_walks_count);
}

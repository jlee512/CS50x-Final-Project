...
var form_template = '<div class="card-container">'
    ...
    + '<input type="radio" id="add-tongariro" class="mdl-radio__button" name="walks-set" value="Tongariro Northern Circuit" checked>'
    ...
    + '<input type="radio" id="add-whanganui" class="mdl-radio__button" name="walks-set" value="Whanganui Journey" checked>'
    ...
    + '<input type="radio" id="add-abel" class="mdl-radio__button" name="walks-set" value="Abel Tasman Coast Track" checked>'
    ...
    + '<input type="radio" id="add-heaphy" class="mdl-radio__button" name="walks-set" value="Heaphy Track" checked>'
    + '<span class="mdl-radio__label">Heaphy Track</span>'
    + '</label>'
    + '</div>'
    + '<div>'
    + '<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="add-paparoa">'
    + '<input type="radio" id="add-paparoa" class="mdl-radio__button" name="walks-set" value="Paparoa Track + Pike29 Memorial Track" checked>'
    ...
    + '<input type="radio" id="add-routeburn" class="mdl-radio__button" name="walks-set" value="Routeburn Track" checked>'
    + '<span class="mdl-radio__label">Routeburn Track</span>'
    + '</label>'
    + '</div>'
    + '<div>'
    + '<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="add-kepler">'
    + '<input type="radio" id="add-kepler" class="mdl-radio__button" name="walks-set" value="Kepler Track" checked>'
    + '<span class="mdl-radio__label">Kepler Track</span>'
    + '</label>'
    + '</div>'
    + '<div>'
    + '<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="add-milford">'
    + '<input type="radio" id="add-milford" class="mdl-radio__button" name="walks-set" value="Milford Track" checked>'
    + '<span class="mdl-radio__label">Milford Track</span>'
    + '</label>'
    + '</div>'
    + '<div>'
    + '<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="add-rakiura">'
    + '<input type="radio" id="add-rakiura" class="mdl-radio__button" name="walks-set" value="Rakiura Track" checked>'
